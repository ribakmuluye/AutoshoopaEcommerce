...
import { FaBox, FaShoppingBag, FaChartLine, FaSignOutAlt, FaSun, FaMoon, FaHome } from 'react-icons/fa';
...
const SellerLayout = () => {
  ...
  const isActive = (path) => {
    return location.pathname === path || (path === '/seller/products' && location.pathname.startsWith('/seller/products/'));
  };
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-5 border-b border-light-border dark:border-dark-border flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-light-textMuted dark:text-dark-textMuted mt-0.5">Seller Dashboard</p>
            </div>
            <button
              onClick={toggleTheme}
          ...
          <nav className="flex-1 p-4 space-y-1">
            <ul className="space-y-1.5">
              ...
              <li>
                ...
                >
                  <FaShoppingBag className="mr-3 text-base" />
                  Orders
                </Link>
              </li>
            </ul>
