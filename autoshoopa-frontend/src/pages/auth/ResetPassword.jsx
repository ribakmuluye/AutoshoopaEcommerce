...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      try {
        await api.post('/api/auth/reset.php', { token, password: formData.password, action: 'confirm' });
      } catch (err) {
        console.log('API password reset confirm fallback:', err);
      }
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <FaLock className="h-5 w-5 text-light-textMuted dark:text-dark-textMuted" />
                </div>
                <input
                  id="password"
                  name="password"
                  ...
                  className="appearance-none block w-full pl-10 pr-10 py-2.5 border border-light-borderHover dark:border-dark-borderHover rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                ...
                <div className="absolute inset-y-0 right-0 pr-3 flex items-center">
                  <button
                    ...
                    className="text-light-textMuted dark:text-dark-textMuted hover:text-light-textMuted dark:text-dark-textMuted focus:outline-none"
                  >
                    {showPassword ? (
